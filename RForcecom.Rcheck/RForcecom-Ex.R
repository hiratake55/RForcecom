...
### Title: RForcecom provides the connection to Force.com and
...
cleanEx()
nameEx("rforcecom.getObjectDescription")
### * rforcecom.getObjectDescription

flush(stderr()); flush(stdout())

### Name: rforcecom.getObjectDescription
### Title: Retrieve object descriptions
### Aliases: rforcecom.getObjectDescription
### Keywords: connection

### ** Examples

## Not run: 
##D  # Retrieve object descriptions
##D   objectName <- "Account"
##D   rforcecom.getObjectDescription(session, objectName)
##D  
## End(Not run)
...
cleanEx()
nameEx("rforcecom.getObjectList")
### * rforcecom.getObjectList

flush(stderr()); flush(stdout())

### Name: rforcecom.getObjectList
### Title: Retrieve a list of objects
### Aliases: rforcecom.getObjectList
### Keywords: connection

### ** Examples

## Not run: 
##D  # Retrieve a list of objects
##D  rforcecom.getObjectList(session)
##D  
## End(Not run)
...
cleanEx()
nameEx("rforcecom.getServerTimestamp")
### * rforcecom.getServerTimestamp

flush(stderr()); flush(stdout())

### Name: rforcecom.getServerTimestamp
### Title: Retrieve a server timestamp
### Aliases: rforcecom.getServerTimestamp
### Keywords: connection
...
##D  username <- "yourname@yourcompany.com"
##D  password <- "YourPasswordSECURITY_TOKEN"
##D  instanceURL <- "https://xx99.salesforce.com/"
##D  apiVersion <- "26.0"
##D  session <- rforcecom.login(username, password, instanceURL, apiVersion)
##D  
## End(Not run)
...
cleanEx()
nameEx("rforcecom.queryMore")
### * rforcecom.queryMore

flush(stderr()); flush(stdout())

### Name: rforcecom.queryMore
### Title: Retrieve remain records when executing a SOQL
### Aliases: rforcecom.queryMore
### Keywords: connection

### ** Examples

## Not run: 
##D  # Retrieve remain records when executing a SOQL
##D  nextRecordsUrl <- "/services/data/v26.0/query/999999999999999ZZZ-2000"
##D  rforcecom.queryMore(session, soqlQuery)
##D  
## End(Not run)
...
##D  rforcecom.retrieve(session, objectName, fields, order = c("Industry","Name"), inverse=TRUE, nullsLast=TRUE)
##D  
## End(Not run)
