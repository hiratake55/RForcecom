...
function(session, objectName, externalIdField, externalId, fields){
 ...
 resultSet <- curlPerform(url=URL, httpheader=httpHeader, headerfunction = h$update, writefunction = t$update, ssl.verifypeer=F, postfields=xmlBody, customrequest="PATCH", .opts=rforcecom.settings.curlopts)
